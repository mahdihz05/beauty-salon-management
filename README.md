...
فرمان `seed_showcase` داده پرحجم و تکرارپذیر می‌سازد؛ از جمله بیش از ۱۱۰۰ کاربر، ۵۰ سالن، ۹۰ شعبه، صدها خدمت و هزاران رزرو به‌همراه پرداخت، نظر، اعلان، کیف پول، تخفیف، تسویه و تیکت. اجرای مجدد این فرمان رکوردهای تکراری ایجاد نمی‌کند.
...
تعداد فعلی تست‌های بک‌اند: **۹۲ تست**. مجموعه مرورگری نیز جریان‌های مشتری، رزرو و پرداخت، مالک، مدیر کل، پذیرش، آرایشگر، ساعات رزرو و واکنش‌گرایی را پوشش می‌دهد.
