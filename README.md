<div align="center" dir="rtl">
  <img src="frontend/public/brand/nobatara-mark.png" width="150" alt="لوگوی نوبت‌آرا" />
  <h1>نوبت‌آرا</h1>
...
نوبت‌آرا یک پلتفرم کامل برای جستجو و رزرو آنلاین خدمات زیبایی، مدیریت عملیات سالن و نظارت مرکزی بر کل سامانه است. محصول از سه فضای اصلی تشکیل شده است:
...
فرمان `seed_showcase` به‌صورت پیش‌فرض دیتاست جمع‌وجور و طبیعی شامل ۱۲۰ مشتری، ۱۲ سالن نمایشی، ۲۴ شعبه و حدود ۵۲۸ رزرو می‌سازد. همراه سه سالن اصلی دمو، محیط نهایی تقریباً ۱۵ سالن دارد. برای مشاهده اثر پاک‌سازی ایمن بدون تغییر داده از `seed_showcase --reset-showcase --dry-run` و برای جایگزینی رکوردهای نشان‌دار از `seed_showcase --reset-showcase` استفاده کنید. سالن یا رزروی که داده بدون نشانگر showcase داشته باشد حفظ می‌شود.
