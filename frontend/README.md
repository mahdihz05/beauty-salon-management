# رابط کاربری Salovina

فرانت‌اند Salovina با React 19، TypeScript و Vite پیاده‌سازی شده و تمام صفحات عمومی، حساب مشتری، رزرو، پنل سالن و پنل مدیر کل را پوشش می‌دهد.
