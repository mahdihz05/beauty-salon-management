...
export function SupportTicketsPage() {
  ...
  const content = (
    <div className={isAgent ? "admin-embedded-page" : "container my-bookings"}>
      {isAgent ? (
        <div className="admin-module-intro">
          <Headphones size={30} />
          <p>مشاهده، پیگیری و پاسخ‌گویی به همه تیکت‌های کاربران سامانه</p>
        </div>
      ) : (
  ...
  if (isAgent) {
    return <AdminLayout title="پشتیبانی و تیکت‌ها">{content}</AdminLayout>;
  }
  return (
